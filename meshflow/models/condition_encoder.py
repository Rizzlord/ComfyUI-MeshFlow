...
class DINOv3Encoder(nn.Module):
    ...
    def __init__(
        ...
        elif "/root/.cache/" in hub_dir:
            hub_dir = hub_dir.replace("/root/.cache/", os.path.expanduser("~/.cache/"))
...
def build_dinov3_encoder(
    ...
    return DINOv3Encoder(
        ...
        hub_dir=cfg.get("hub_dir", os.path.expanduser("~/.cache/torch/hub/facebookresearch_dinov3_main")),
